...
def _load_config() -> Dict[str, Any]:
    ...
    try:
        ...
        return {
            ...
            "top_k": 5,
            "rerank": True,
            "system_prompt": "You are an expert accounting assistant. Answer only based on the provided financial documents. Be precise with numbers. If unsure, say \"I cannot confirm this from the documents.\"",
